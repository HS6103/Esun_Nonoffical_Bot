...
def testIntent():
    ...
    inputLIST = ['如何開卡','如何補寄簡訊','信用卡申訴陳情','如何停用信用卡','如何查詢結帳日','如何申請信用卡','信用卡遺失怎麼辦','如何使用紅利點數','如何更改戶籍地址','如何申請個人信貸','如何補寄電子帳單','信用卡利息如何計算','信貸繳款有哪些方式','如何查詢繳款截止日','結帳日是否可以更改','信用卡違約金如何計算','如何使用預借現金功能','如何更改銀行基本資料','如何登錄道路救援服務','如何設定預借現金密碼','如何變更我的中文姓名','辦卡有缺資料如何補件','信用卡繳款方式包含哪些','信用卡額度是否可以調整','個人信貸撥款時間要多久','個人信貸有哪些撥款方式','如何更改信用卡帳單地址','如何查詢信用卡即時交易','如何查詢信用卡帳單金額','如何查詢信用卡繳款紀錄','如何查詢信用卡辦卡進度','如何查詢歷史的消費明細','如何查詢目前可用的額度','如何查詢預借現金的額度','如何計算預借現金手續費','拾獲本行信用卡該怎麼做','申請個人信貸的流程為何','繳款截止日是否可以更改','如何查詢信用卡之持卡狀況','如何查詢信用卡未請款消費','如何查詢個人信貸申辦進度','如何申請提前還款結清貸款','信用卡利息／違約金如何計算','如何查詢信用卡未入帳單交易','帳單有年費問題如何爭取減免','申辦額度調整缺資料如何補件','如何修改帳戶自動扣繳卡費資料','為什麼已經刷退卻還沒收到退款','申請個人信貸需要有玉山帳戶嗎','申請個人信貸需要準備哪些文件','信用卡不限金額消費通知如何設定','信用卡道路救援服務項目包含哪些','哪裡可以查詢信用卡優惠活動內容','如何設定每筆刷卡消費都收到通知','已經有向銀行貸款還可以再申請嗎','信用卡受損感應不良如何申請補換發','如何查詢推薦好友辦卡是否符合資格','持信用卡在國外消費會收取什麼費用','提前還款是否須負擔提前清償違約金','收到逾期簡訊通知是否會有利息產生','如何查詢信用卡未請款消費或即時交易','對當月帳單的消費款項有疑問該怎麼做','如何申請信用卡帳單使用他行帳戶自動扣繳','有其他家銀行貸款是否可申請玉山信貸債務整合']
