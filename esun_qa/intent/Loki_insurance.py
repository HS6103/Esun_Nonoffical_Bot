...
def getResult(inputSTR, utterance, args, resultDICT, refDICT, pattern=""):
    ...
    if utterance == "[一定]要完成「[網路]投保註冊」[才][可以]投保嗎":
        if CHATBOT_MODE:
    ...
    if utterance == "[一次]繳跟[分期][繳保費]的對[我]的[年金]給付有什麼影響":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[是]否[可以]透過[網路]投保[線上]執行提[前]解約":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[暫時]停止扣繳[續期每月定額][保險費]要如何申辦":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[每月][定額][保險費]的宣告[利率]與投保時的宣告[利率]是[一樣]嗎":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[網路]投保[年金][保險][前][應]注意哪些[事項]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[網路]投保[過程][中]如何確認[個人]的[身分]驗證":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[網路]投保完成[後]何時[可]收到[保險單]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[網路]投保完成[後]如何確定投保[成功]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "在[國外][是]否還[可]投保[旅行綜合險]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "在[玉山銀行]查詢或下載[任何][網路]投保的[相關][資訊][是]否需要[另][外]付費":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "如何取得[詳細]的[網路]投保[商品]說明及[保險條款]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "如何確認[續期每月定額][保險費][是]否有扣款[成功]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "已[屆][壯年]的[我][應該]規劃什麼樣的[保險]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "恢復扣繳[續期每月定額][保險費]要如何申辦":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "投保時選擇[年金][一次]給付或[分期]給付[將]來[可以]改嗎":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "未申請扣繳[續期每月定額][保險費][將]來要如何申辦":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "申請[續期每月定額][保險費]繳費[成功][後]何時[會]開始扣款":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "辦理[網路]投保[一定]要填寫[e-mail]嗎":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "透過[玉山銀行]進行[網路]投保如何確保[我]的[交易][安全][性]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
